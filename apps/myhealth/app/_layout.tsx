...
function RootLayoutNav() {
  ...
  return (
    <Stack>
      ...
      <Stack.Screen name="routines/create" options={{ title: 'Create Routine', headerShown: false }} />
      <Stack.Screen name="routines/details" options={{ title: 'Routine Details', headerShown: false }} />
